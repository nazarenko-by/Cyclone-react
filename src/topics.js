...
const topics = [
    {
        ...
        "tag": ["Fashion"],
        "title": "<div>19 Artists<br/>at Galerie Mathgoth</div>",
    ...
    },
    {
        ...
        "tag":["Art", "LiveStyle"],
        "title":"<div>Cy Twombly<br/>Painting Can Bring<br/>Eight Or Nine<br/>Figures In Auction!</div>",
    ...
    },
    {
        ...
        "tag":["Art", "Design"],
        "title":"<div>Ten Inspiration<br/>Picasso Sketches</div>",
    ...
    },
    {
        ...
        "title":"<div>New Zealand's<br/>Backpacker Buses</div>",
...

    {
        ...
        "tag":["Fashion", "Art"],
        "title":"<div><span className=\"title-line\">Discovering New</span><br/>Worlds Of experience<br/>With Synesthesia In Art</div>",
    ...
    },
    {
        ...
        "tag":["Art", "LiveStyle"],
        "title":"<div>Eight Free Museums<br/>In Europe You Have<br/><span className=\"text-line\">To Check Out</span></div>",
    ...
    },
    {
        ...
        "tag":["Travel", "LiveStyle"],
        "title":"<div>How To Know<br/>If The Travel Info<br/>You Find Is Legit</div>",
    ...
    },      
    {
        ...
        "tag": ["Fashion"],
        "title":"<div>10 Best Museum<br/>Shops to visit</div>",
    ...
    },
    {
        "id": 13,
        "tag": ["Fashion", "Art"],
        "title": "<div>The fascination <span className=\"italic\"><span className=\"yellow-text text-line\">with Alchemy</span> in Art</span></div>",
