...
const Contacts = () => {
    return(
        <div className="contacts-page">
            ...
            <div className="text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed sunt accusantium vitae. Possimus pariatur rerum doloremque in quisquam soluta corrupti repellendus culpa beatae dolorum ipsam cum laboriosam, optio aperiam vel.</div>
            <div className="map">
